...
__published:	// IDE-managed Components
	...
	TTabSheet *FACTURA;
	TPanel *Panel7;
	TSpeedButton *B_IDENTIFICA;
	TSpeedButton *SpeedButton19;
	TEdit *NR_F;
	TDateTimePicker *DATA_F;
	TEdit *EMITENT_F;
	TPanel *Panel8;
	TPageControl *PageControl4;
	TTabSheet *MAIN_F;
	TSpeedButton *BINREG_F;
	TSpeedButton *BANULEAZA_F;
	TSpeedButton *BURM_F;
	...
	TTabSheet *MAIN_UM;
	TSpeedButton *BSELECTEAZA_UM;
	TSpeedButton *BANULEAZA_UM;
	...
	void __fastcall EMITENT_FKeyPress(TObject *Sender, System::WideChar &Key);
	void __fastcall SpeedButton19Click(TObject *Sender);
	void __fastcall SpeedButton12Click(TObject *Sender);
	void __fastcall SpeedButton15Click(TObject *Sender);
	void __fastcall B_IDENTIFICAClick(TObject *Sender);
	...
	void __fastcall BSELECTEAZA_UMClick(TObject *Sender);
	void __fastcall RB1Click(TObject *Sender);
	void __fastcall RB2Click(TObject *Sender);
	void __fastcall EPRODChange(TObject *Sender);
	...
	void __fastcall BINREG_FClick(TObject *Sender);
	void __fastcall SpeedButton14Click(TObject *Sender);
	void __fastcall stoc(int minus);
	void __fastcall BANULEAZA_FClick(TObject *Sender);
	void __fastcall SpeedButton21Click(TObject *Sender);
	void __fastcall BURM_FClick(TObject *Sender);
