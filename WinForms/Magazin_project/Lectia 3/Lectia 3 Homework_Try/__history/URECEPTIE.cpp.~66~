...
int EMITENT_ID, FACTURA_ID, PRODUS_ID, UM_ID, STOCK1, STOCK_ID;
//---------------------------------------------------------------------------
...
{
//	INREG_F->TabVisible=false;
//	GOL_F->TabVisible=false;
//	MAIN_F->TabVisible=false;
//	EDIT_F->TabVisible=true;
...
void __fastcall TFRECEPTIE::SpeedButton22Click(TObject *Sender)
{
	 if (PRODUS_FF->Text!="" && UM_FF->Text!="" && COST_FF->Text!="" && TVA_FF->Text!="") {
	   ...
	   DM->QLiber->SQL->Add(" WHERE FACTURA_REC_ID = :FACTURA_REC_ID");
